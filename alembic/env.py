...
if settings.DATABASE_URL:
    # Use set_main_option with raw=True to avoid ConfigParser interpolation issues
    # This prevents issues with % characters in passwords (like %40 for @)
...
def run_migrations_offline() -> None:
    ...
    """
    # Get URL from attributes first (set from settings), fallback to config
